(function (global) {
  ...
  const algorithms = [
    ...
    { id: "bfs", category: "graph", name: "Breadth-First Search", short: "BFS", status: "ready", view: "grid", generate: "grid", best: "O(V+E)", avg: "O(V+E)", worst: "O(V+E)", space: "O(V)", blurb: "Explores the maze level by level until it reaches the goal." },
    { id: "dfs", category: "graph", name: "Depth-First Search", short: "DFS", status: "ready", view: "grid", generate: "grid", best: "O(V+E)", avg: "O(V+E)", worst: "O(V+E)", space: "O(V)", blurb: "Explores as far as possible along each branch before backtracking." },
    { id: "dijkstra", category: "graph", name: "Dijkstra", short: "Dijkstra", status: "ready", view: "grid", generate: "grid", best: "O(E log V)", avg: "O(E log V)", worst: "O(E log V)", space: "O(V)", blurb: "Finds the cheapest path on a weighted grid with non-negative costs." },
    { id: "astar", category: "graph", name: "A* Search", short: "A*", status: "ready", view: "grid", generate: "grid", best: "O(E)", avg: "O(E log V)", worst: "O(E log V)", space: "O(V)", blurb: "Best-first pathfinding that adds a Manhattan heuristic to Dijkstra." },
    ...
    { id: "bst", category: "tree", name: "BST Search", short: "BST", status: "ready", view: "tree", generate: "tree", needsTarget: true, best: "O(log n)", avg: "O(log n)", worst: "O(n)", space: "O(n)", blurb: "Walks left or right from the root until the target node is found." },
    { id: "inorder", category: "tree", name: "Inorder Traversal", short: "Inorder", status: "ready", view: "tree", generate: "tree", best: "O(n)", avg: "O(n)", worst: "O(n)", space: "O(h)", blurb: "Visits left subtree, then the node, then the right subtree." },
    { id: "preorder", category: "tree", name: "Preorder Traversal", short: "Preorder", status: "ready", view: "tree", generate: "tree", best: "O(n)", avg: "O(n)", worst: "O(n)", space: "O(h)", blurb: "Visits the node, then the left subtree, then the right subtree." },
    { id: "postorder", category: "tree", name: "Postorder Traversal", short: "Postorder", status: "ready", view: "tree", generate: "tree", best: "O(n)", avg: "O(n)", worst: "O(n)", space: "O(h)", blurb: "Visits left and right subtrees before the node itself." },
    { id: "levelorder", category: "tree", name: "Level-Order Traversal", short: "Level", status: "ready", view: "tree", generate: "tree", best: "O(n)", avg: "O(n)", worst: "O(n)", space: "O(n)", blurb: "Visits nodes top to bottom, left to right, using a queue." },
    ...
    { id: "lcs", category: "dp", name: "Longest Common Subsequence", short: "LCS", status: "ready", view: "table", generate: "table", best: "O(nm)", avg: "O(nm)", worst: "O(nm)", space: "O(nm)", blurb: "Fills a DP table to reconstruct the longest shared subsequence of two strings." },
    ...
    { id: "coin", category: "dp", name: "Coin Change", short: "Coins", status: "ready", view: "table", generate: "table", best: "O(nA)", avg: "O(nA)", worst: "O(nA)", space: "O(A)", blurb: "Computes the fewest coins needed to make an amount." },
    ...
    { id: "nqueens", category: "backtracking", name: "N-Queens", short: "N-Queens", status: "ready", view: "board", generate: "board", best: "O(n!)", avg: "O(n!)", worst: "O(n!)", space: "O(n)", blurb: "Places n queens so none share a row, column, or diagonal." },
    { id: "maze", category: "backtracking", name: "Maze Generation", short: "Maze", status: "ready", view: "grid", generate: "grid", best: "O(RC)", avg: "O(RC)", worst: "O(RC)", space: "O(RC)", blurb: "Recursive backtracker carves passages through a grid of walls." },
